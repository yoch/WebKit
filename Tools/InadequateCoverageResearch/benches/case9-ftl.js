// Case 9: allow FTL. Same phase change as case 1.
...
out("REPRO name=case9-ftl elapsed_ms=" + (nowMs() - start).toFixed(6) + " sink=" + score.state.sink + " size=" + results.size + " dfg=" + ((typeof numberOfDFGCompiles === "function") ? numberOfDFGCompiles(score) : -1));
