// Topology: top-level `let sink` is a global lexical binding on standalone jsc script.
...
out("REPRO name=topo-global-let-sink elapsed_ms=" + (nowMs() - start).toFixed(6) + " sink=" + sink + " size=" + results.size);
